      ...
      <div className={styles.scrollContainer}>
        <div>
          ...
          <p className={styles.bio}>
            ...
            understand and navigate the complex relationship between AI and
            human behavior. I worry that AI, as with all new general disruptive
            technologies, will create further inequality in the world and want
            to help every person become augmented.
          </p>
